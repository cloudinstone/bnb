...
function themetek_add_meta_box() {
	...
	foreach ( $screens as $screen ) {
		...
		add_meta_box(
			'themetek_pagetitle',
			esc_html__( 'Page Title and Subtitle', 'etalon' ),
		...
		add_meta_box(
			...
			esc_html__( 'Page Settings', 'etalon' ),
	...
	// Single portfolio page Templates
		add_meta_box(
			...
			esc_html__( 'Portfolio Template', 'etalon' ),
			'themetek_meta_box_portfolio_templates',
			'portfolio',
			'side',
			'default'
		);
...
function dthemetek_save_meta_box_data_portfolio( $post_id ) {
	// Check if our nonce is set.
