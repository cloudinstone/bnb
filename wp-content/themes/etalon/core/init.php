...
// ------------------------------------------------------------------------
	...
	require get_template_directory() . '/core/theme-activation.php';

	// Add post meta boxes
	require get_template_directory() . '/core/theme-pagemeta.php';

	// Register widgetized areas
	require get_template_directory() . '/core/theme-sidebars.php';

	// Add theme custom widgets
	require get_template_directory() . '/core/widgets/socials.php';
...
function keydesign_enqueue_comments_reply() {
	...
	add_action(
		...
		function ( $q ) {
			if ( ! is_admin() && $q->is_main_query() && $q->is_search() ) {
				$q->set( 'post_type', array( 'my_custom_post_type', 'post' ) );
			}
		}
	);
	...
	function keydesign_redirect_visitors() {
		$redux_ThemeTek = get_option( 'redux_ThemeTek' );
		if ( ! isset( $redux_ThemeTek['tek-coming-soon'] ) ) {
			$redux_ThemeTek['tek-coming-soon'] = '';
		}
